...
| SUS | Instrumento SUS, formula, base de resultados y plantilla de interpretacion | `05-sus/` | Pendiente de aplicacion real | No se registran respuestas inventadas. |
